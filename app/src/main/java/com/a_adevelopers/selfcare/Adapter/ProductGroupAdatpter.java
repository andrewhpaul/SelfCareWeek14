...
public class ProductGroupAdatpter extends RecyclerView.Adapter<ProductGroupAdatpter.Holder> implements Filterable {
    ...
    public ProductGroupAdatpter(Context context, ArrayList<Model> arrayList) {
