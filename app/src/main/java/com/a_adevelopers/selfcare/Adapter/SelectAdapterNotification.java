...
import com.a_adevelopers.selfcare.view.AddExpiryNotificationActivity;
import com.a_adevelopers.selfcare.view.AddProductActivity;

import java.util.ArrayList;
import java.util.List;

public class SelectAdapterNotification extends RecyclerView.Adapter<SelectAdapterNotification.Holder> implements Filterable {
    ...
    public SelectAdapterNotification(Context context, ArrayList<Model> arrayList) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, AddExpiryNotificationActivity.class);
