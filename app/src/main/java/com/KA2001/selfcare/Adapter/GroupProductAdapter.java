...
import com.KA2001.selfcare.Model.GPModel;
import com.KA2001.selfcare.R;
import com.KA2001.selfcare.db.SqlLite;

import java.util.ArrayList;

public class GroupProductAdapter extends RecyclerView.Adapter<GroupProductAdapter.Holder>  {
    private Context context;
    private ArrayList<GPModel> arrayList;
    private ArrayList<GPModel> exampleArrayList;

    SqlLite databaseHelper;

    public GroupProductAdapter(Context context, ArrayList<GPModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, final int position) {
        ...
        // get for views
        GPModel model = arrayList.get(position);
...
//        holder.purchaseDate.setVisibility( View.GONE);
       /*holder.expiryDate.setText(View.GONE);
        holder.url.setText(View.GONE);
